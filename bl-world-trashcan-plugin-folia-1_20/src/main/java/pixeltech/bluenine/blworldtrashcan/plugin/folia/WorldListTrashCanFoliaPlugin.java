...
public final class WorldListTrashCanFoliaPlugin extends JavaPlugin {
    ...
    private WorldListTrashCanFoliaExpansion expansion;
    ...
    public void onEnable() {
        ...
        reloadConfig();
        this.customModelDataSupport = CustomModelDataSupport.detect(getLogger());
    ...
    private void registerPlaceholderApi() {
        ...
        this.expansion = new WorldListTrashCanFoliaExpansion(this);
    ...
    /** 注册单个命令执行器。 */
    private void registerCommand(String name, WorldListTrashCanFoliaCommand executor) {
    ...
    public boolean debugRgb(final Player player) {
        return runForPlayerRegion(player, new Runnable() {
            ...
            @Override
            public void run() {
                BukkitRgbDebugSender.send(WorldListTrashCanFoliaPlugin.this, player);
            }
        });
    }
