...
import pixeltech.bluenine.blworldtrashcan.bukkit.config.BrandCaseDataFolderMigrator;
...
/** Folia 1.20 产物入口。 */
public final class BlWorldTrashCanFoliaPlugin extends JavaPlugin {
    ...
    private BlWorldTrashCanFoliaExpansion expansion;
    ...
    public void onEnable() {
        BrandCaseDataFolderMigrator.migrateIfNeeded(this);
        saveDefaultConfigs();
    ...
    private void registerCommands() {
        BlWorldTrashCanFoliaCommand executor = new BlWorldTrashCanFoliaCommand(this);
    ...
    private void registerPlaceholderApi() {
        ...
        this.expansion = new BlWorldTrashCanFoliaExpansion(this);
    ...
    /** 注册单个命令执行器。 */
    private void registerCommand(String name, BlWorldTrashCanFoliaCommand executor) {
