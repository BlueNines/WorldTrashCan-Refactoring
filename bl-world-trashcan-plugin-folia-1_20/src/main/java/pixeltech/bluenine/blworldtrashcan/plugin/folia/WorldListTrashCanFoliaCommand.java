...
/** 新架构主命令，当前只提供架构验证命令。 */
public final class WorldListTrashCanFoliaCommand implements CommandExecutor, TabCompleter {
    ...
    /** 创建命令执行器。 */
    public WorldListTrashCanFoliaCommand(WorldListTrashCanFoliaPlugin plugin) {
        this.plugin = plugin;
    }
