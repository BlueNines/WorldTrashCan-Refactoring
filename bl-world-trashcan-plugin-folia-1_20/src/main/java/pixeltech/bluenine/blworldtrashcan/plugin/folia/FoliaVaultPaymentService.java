...
/** Vault 经济扣费服务。 */
public final class FoliaVaultPaymentService implements PaymentService {
    private final Economy economy;

    /** 创建 Vault 扣费服务。 */
    private FoliaVaultPaymentService(Economy economy) {
    ...
    public static PaymentService create(JavaPlugin plugin) {
        ...
        return new FoliaVaultPaymentService(provider.getProvider());
    }
