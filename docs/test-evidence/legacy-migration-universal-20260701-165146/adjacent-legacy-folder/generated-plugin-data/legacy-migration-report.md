# BLWorldTrashCan 旧配置迁移报告

- 迁移时间: 2026-07-01 16:52:00
- 来源目录: `C:\Users\pc\Desktop\ai开发插件\待重构插件\WorldListTrashCan重构\refactor-workspace\build\legacy-migration-matrix\20260701-165146\adjacent-legacy-folder\server\plugins\WorldListTrashCan`
- 来源类型: 相邻旧插件数据目录
...
- `Set.ChatConsoleLogFlag -> notify.chat.console-log`
...
- 已生成本报告后，后续启动不会重复迁移；如需重跑，请先备份并删除本报告。
