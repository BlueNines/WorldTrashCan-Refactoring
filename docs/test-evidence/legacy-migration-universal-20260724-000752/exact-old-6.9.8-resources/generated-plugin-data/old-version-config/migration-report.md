...
- 迁移时间: 2026-07-24 00:07:58
- 来源目录: `C:\Users\pc\Desktop\ai开发插件\待重构插件\WorldListTrashCan重构\refactor-workspace\build\legacy-migration-matrix\20260724-000752\exact-old-6.9.8-resources\server\plugins\WorldListTrashCan\old-version-config`
...
- `message/1.12.2message_en.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/1.12.2message_es.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/1.12.2message_zh.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/1.12.2message_zh_TW.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/message_en.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/message_es.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/message_zh.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
- `message/message_zh_TW.yml | 新版语言键结构已变化，文件已完整备份，请按需人工合并到 messages/`
