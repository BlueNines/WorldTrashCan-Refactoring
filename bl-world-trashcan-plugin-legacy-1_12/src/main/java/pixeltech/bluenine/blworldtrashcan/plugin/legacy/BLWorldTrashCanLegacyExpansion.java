...
public final class BLWorldTrashCanLegacyExpansion extends PlaceholderExpansion {
    private final BLWorldTrashCanLegacyPlugin plugin;

    /** 创建 PAPI 扩展。 */
    public BLWorldTrashCanLegacyExpansion(BLWorldTrashCanLegacyPlugin plugin) {
        this.plugin = plugin;
    }
