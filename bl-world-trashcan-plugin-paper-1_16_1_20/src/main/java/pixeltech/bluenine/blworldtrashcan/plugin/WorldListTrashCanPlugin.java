...
public final class WorldListTrashCanPlugin extends JavaPlugin {
    ...
    private WorldListTrashCanExpansion expansion;
    ...
    private void registerPlaceholderApi() {
        ...
        this.expansion = new WorldListTrashCanExpansion(this);
    ...
    /** 注册单个命令执行器。 */
    private void registerCommand(String name, WorldListTrashCanCommand executor) {
