...
/** Vault 经济扣费服务。 */
public final class BukkitVaultPaymentService implements PaymentService {
    private final Economy economy;

    /** 创建 Vault 扣费服务。 */
    private BukkitVaultPaymentService(Economy economy) {
    ...
    public static PaymentService create(JavaPlugin plugin) {
        ...
        return new BukkitVaultPaymentService(provider.getProvider());
    }
