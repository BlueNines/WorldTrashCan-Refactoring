...
public final class WorldListTrashCanBukkitPlugin extends JavaPlugin {
    ...
    private WorldListTrashCanBukkitExpansion expansion;
    ...
    private boolean supportsCustomModelDataVersion() {
        ...
        try {
            return Integer.parseInt(parts[1]) >= 14;
    ...
    private void registerCommands() {
        WorldListTrashCanBukkitCommand executor = new WorldListTrashCanBukkitCommand(this, apiHost.commandRegistry());
    ...
    private void registerPlaceholderApi() {
        ...
        this.expansion = new WorldListTrashCanBukkitExpansion(this);
    ...
    /** 注册单个命令执行器。 */
    private void registerCommand(String name, WorldListTrashCanBukkitCommand executor) {
