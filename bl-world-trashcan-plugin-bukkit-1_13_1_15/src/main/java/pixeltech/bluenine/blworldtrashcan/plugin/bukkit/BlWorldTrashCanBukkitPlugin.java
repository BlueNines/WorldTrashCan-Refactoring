...
public final class BlWorldTrashCanBukkitPlugin extends JavaPlugin {
    ...
    private void registerCommands() {
        BlWorldTrashCanBukkitCommand executor = new BlWorldTrashCanBukkitCommand(this);
    ...
    private void registerPlaceholderApi() {
        ...
        this.expansion = new BlWorldTrashCanBukkitExpansion(this);
    ...
    /** 注册单个命令执行器。 */
    private void registerCommand(String name, BlWorldTrashCanBukkitCommand executor) {
